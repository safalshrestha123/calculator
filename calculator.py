...
btn7=Button(window,text='7',padx=15,pady=10,bd=5,fg="black",font=('arial',20,'bold'),command=lambda:btnClick(7),
            bg="powder blue").grid(row=2,column=0,columnspan=1)
btn8=Button(window,text='8',padx=15,pady=10,bd=5,fg="black",font=('arial',20,'bold')
            ,command=lambda:btnClick(8),bg='powder blue').grid(row=2,column=1)

btn9=Button(window,text='9',padx=15,pady=10,bd=5,fg="black",font=('arial',20,'bold')
            ,command=lambda:btnClick(9),bg='powder blue').grid(row=2,column=2)
...
btn5=Button(window,text='5',padx=10,pady=10,bd=8,fg="black",font=('arial',20,'bold')
            ,command=lambda:btnClick(5),bg='powder blue').grid(row=3,column=1)

btn6=Button(window,text='6',padx=10,pady=10,bd=8,fg="black",font=('arial',20,'bold')
            ,command=lambda:btnClick(6),bg='powder blue').grid(row=3,column=2)
...
btn2=Button(window,text='2',padx=10,pady=10,bd=8,fg="black",font=('arial',20,'bold')
            ,command=lambda:btnClick(2),bg='powder blue').grid(row=4,column=1)

btn3=Button(window,text='3',padx=10,pady=10,bd=8,fg="black",font=('arial',20,'bold')
            ,command=lambda:btnClick(3),bg='powder blue').grid(row=4,column=2)
...
eqlbtn=Button(window,text='=',padx=10,pady=10,bd=8,fg="black",font=('arial',20,'bold'),bg='powder blue'
              ,command=btnEquallInput).grid(row=5,column=2)



addbtn=Button(window,text='+',padx=10,pady=10,bd=8,fg="black",font=('arial',20,'bold')
              ,command=lambda:btnClick('+'),bg='powder blue').grid(row=5,column=3)
